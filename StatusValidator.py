  ...
  def WinByDiagonalPlacement(cls, board : Board, playerMarker : str):
    ...
    for column in range(columns - 3):
      for row in range(rows - 3):
        ...
        secondDiagonalPlacement = boardArray[row + 1] [column + 1] == playerMarker
        thirdDiagonalPlacement = boardArray[row + 2] [column + 2] == playerMarker
        fourthDiagonalPlacement = boardArray[row + 3] [column + 3] == playerMarker
        if firstDiagonalPlacement and secondDiagonalPlacement and thirdDiagonalPlacement and fourthDiagonalPlacement:
          return True
